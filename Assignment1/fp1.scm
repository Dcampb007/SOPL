...
(define (helper2 atm L)
  (cond
    ...
    ((and (member atm alphabet) (not_empty L) (list? L)) (helper2 (car L) (cdr L))) ; if atm is in [a-z], call helper 
    ((and (not (member atm alphabet)) (null? L)) atm) ; If atm not in [a-z] and L is null, return atm 
    ((and (not (member atm alphabet)) (list? L)) (+ atm (helper2 (car L) (cdr L)))) ; Normal case
